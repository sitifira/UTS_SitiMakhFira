            ...
            <div class="col-8 m-auto">
                <div class="card shadow p-3 mb-5 bg-body-tertiary rounded">
                    <div class="card-header">
                        <b><i class="fas fa-user-plus"></i> ADD EMPLOYEE</b>
                    </div>
                    <div class="card-body">
                        <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                <label for="nm_karyawan" class="form-label"><i class="fas fa-user"></i> Full Name</label>
                                <input name="nm_karyawan" type="text" class="form-control" id="nm_karyawan"
                            ...
                            <div class="mb-3">
                                ...
                                <input name="tgl_masuk" type="date" class="form-control" id="tgl_masuk"
                                    aria-describedby="dateHelp" required>
                            </div>
                            <div class="mb-3">
                                <label for="gaji" class="form-label"><i class="fas fa-dollar-sign"></i> Salary</label>
                                <input name="gaji" type="number" class="form-control" id="gaji"
